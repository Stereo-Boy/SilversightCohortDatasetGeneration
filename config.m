...
EXECUTE_DM=true; % Demographic data - sex at birth and date of birth (european format)
EXECUTE_UFOV=true; %  
EXECUTE_BAT=true; % only local data. Eyes must be merged since each subject only sees  the dominant eye
