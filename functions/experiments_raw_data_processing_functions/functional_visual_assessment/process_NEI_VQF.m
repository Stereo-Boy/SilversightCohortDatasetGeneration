...
%PROCESS_NEI_VQF 
% this function reads data from raw_data_examples/Analyse-NEI-VQF-date-working_version.xlsm (excel file written by Karine)
...
% and generate processed_data_files/VQF_data.csv  which contains four scores : NEI-VFQ (LFSES25, LFVS25, LFSES39, LFVFS39)
    ...
    if vqf_file_found(1)    
        ...
        RAW_NEI_VFQ_FILE_PATH = [LOCAL_DATA_DIR FILE_NAME];
        ...
        number_of_rows = height(raw_file_NEIVQF_ID);
        table_VQF = table(table2array(raw_file_NEIVQF_ID),...
                  table2array(raw_file_NEIVQF_LFSES25(1:number_of_rows,width(raw_file_NEIVQF_LFSES25))),...
                  table2array(raw_file_NEIVQF_LFVS25(1:number_of_rows,width(raw_file_NEIVQF_LFVS25))),...
                  table2array(raw_file_NEIVQF_LFSES39(1:number_of_rows,width(raw_file_NEIVQF_LFSES39))),...
                  table2array(raw_file_NEIVQF_LFVFS39(1:number_of_rows,width(raw_file_NEIVQF_LFVFS39))));
        ...
        writetable(table_VQF,[PROCESSED_DATA_DIR 'NEI-VQF' '.xlsm'])
    end
