...
%   Detailed explanation goes here
    ...
    cogT = dir(fullfile([LOCAL_DATA_DIR 'cogT_DATA'],'**/*.mat'));
    cogT_file_found = size(cogT);
    if cogT_file_found(1)    
        ...
        for n = 1:length(cogT)
            load([cogT(n).folder '\' cogT(n).name]);
        ...
        writetable(cogT_table,[PROCESSED_DATA_DIR 'cogT_Data' ],'FileType','spreadsheet');
    end
