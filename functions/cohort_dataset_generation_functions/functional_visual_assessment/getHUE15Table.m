...
% this file is typed manualy both on eCRF and the local version 
    ...
    if HUE15_ECRF_DATA==1 || HUE15_ECRF_DATA==3
        ...
        hue15_TABLE = readtable([FILE_NAME(1).folder '\' FILE_NAME(1).name]);
    ...
    if HUE15_ECRF_DATA==2 || HUE15_ECRF_DATA==3
        ...
        subjects_numbers_TABLE = readtable([FILE_NAME(1).folder '\' FILE_NAME(1).name]);
        ...
        hue15_TABLE=removeDuplicities(hue15_TABLE);
