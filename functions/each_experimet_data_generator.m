...
% adding paths where the processing functions are 
addpath('helpers');
addpath('experiments_raw_data_processing_functions/functional_visual_assessment');
addpath('experiments_raw_data_processing_functions/functional_visual_assessment/helpers');
addpath('experiments_raw_data_processing_functions/functional_hearing_assessment');
addpath('experiments_raw_data_processing_functions/functional_hearing_assessment/helpers');
addpath('experiments_raw_data_processing_functions/neuropsychological_examination');
...
if AUDIO_GUI process_Audiogram();  end % calling the function "process_Audiogram()"

%%% 3-Neuropsychological examination
if EXECUTE_COG_T process_cogT_Data(); end % A. MMS, GHQ, FES, STAI, Persp
if EXECUTE_VTS process_VTS(VTS_DATA_ONE_FILE_FOR_ALL); end % B. VTS (D3S1CAReponses, TMTS2DSCOREDif, TMTS2QSCOREQuo, FGTS11LSsommed, FGTS11RKVArest, FGTS11RLVArest, CORSIS1UBSEmpa, CORSIS5UBSEmpa, INHIBS3DWIndic).
